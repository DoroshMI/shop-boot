...
(function (J, d) {
    ...
    var x,
        y, F, G,
        z = d.module("ngRoute", []).info({angularVersion: "1.6.5-build.5414+sha.bf0af6d"}).provider("$route", function () {
            function t(a, f) {
            ...
            this.when = function (a, f) {
                ...
                a && (c =
                    "/" === a[a.length - 1] ? a.substr(0, a.length - 1) : a + "/", g[c] = d.extend({redirectTo: a}, u(c, b)));
                return this
            };
            ...
            this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", "$browser", function (a, f, b, c, m, k, u, n) {
                function p(e) {
                    var h = q.current;
                    (y = (s = C()) && h && s.$$route === h.$$route && d.equals(s.pathParams,
